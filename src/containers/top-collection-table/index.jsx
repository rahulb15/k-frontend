...
const TopCollectionTableArea = ({ className, space, data }) => {
    ...
    return (
        ...
        >
            ...
            <div className="title-wrapper ml--20">
                    ...
                    <div className="col-12">
                        <TabContainer defaultActiveKey="nav-home">
                            ...
                            <TabContent>
                                ...
                                >
                                    <div className="lg-product-wrapper colum-1 two-colum-parent-product col-lg-6">
...
TopCollectionTableArea.propTypes = {
...
TopCollectionTableArea.defaultProps = {
    space: 1,
};

export default TopCollectionTableArea;
