...
//         else if (marketplaceSubTab === "onAuction") nftsToRender = onAuctionNfts;
//         else if (marketplaceSubTab === "onDutchAuction") nftsToRender = onDutchAuctionNfts;
...
//                             <div className="col-12">
//                                 <nav className="tab-button-one">
//                                     <Nav className="nav nav-tabs" id="marketplace-sub-tab" role="tablist">
//                                         <Nav.Link
//                                             as="button"
//                                             eventKey="onSale"
//                                             onClick={() => handleMarketplaceSubTabChange("onSale")}
//                                             active={marketplaceSubTab === "onSale"}
//                                         >
//                                             On Sale
//                                         </Nav.Link>
//                                         <Nav.Link
//                                             as="button"
//                                             eventKey="onAuction"
//                                             onClick={() => handleMarketplaceSubTabChange("onAuction")}
//                                             active={marketplaceSubTab === "onAuction"}
//                                         >
//                                             On Auction
//                                         </Nav.Link>
//                                         <Nav.Link
...
//                                             onClick={() => handleMarketplaceSubTabChange("onDutchAuction")}
//                                             active={marketplaceSubTab === "onDutchAuction"}
//                                         >
//                                             On Dutch Auction
//                                         </Nav.Link>
//                                     </Nav>
...
const AuthorProfileArea = ({ className }) => {
            ...
            if (activeTab === "nav-home") {
                try {
                    ...
                    if (marketplaceSubTab === "onSale") {
                        ...
                        // Replace with actual API call for Dutch auction NFTs
                        const response =
                            await nftServices.getOwnDutchAuctionNfts(
                                data,
                                pageNo,
                                limit,
                                search
    ...
    className={clsx("priority-pass-tab", {
        active: activeTab === "nav-priority-pass",
    })}
>
    Priority Pass
</Nav.Link>
                    ...
                    <TabContent className="tab-content rn-bid-content">
                    <TabPane className="row d-flex g-5" eventKey="nav-priority-pass">
